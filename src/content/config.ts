    ...
    media: z
      .array(
        z.object({
          ...
          // 24:5는 360° 벽면을 한 줄로 편 파노라마(4.8:1). 21:9로 담으면 위아래에
          // 검은 띠가 남는데, 그 띠가 작품의 여백처럼 읽혀 버린다.
          ratio: z.enum(["16:9", "4:3", "1:1", "21:9", "24:5", "9:16"]).default("16:9"), // 영상 비율
          poster: z.string().optional().default(""), // 영상 시작 전 화면(정지 프레임). 없으면 첫 프레임
